...
@EnableJpaRepositories(basePackages = "br.com.relesi.rest.modelo.repositorios")
public class ConfiguracaoBD {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
		...
		entityManagerFactoryBean.setPackagesToScan("br.com.relesi.rest.modelo.entidades");
